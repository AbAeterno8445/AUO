...
class Tile(pygame.sprite.DirtySprite):
    def __init__(self, tile_id, texture, pos, flags=[]):
        ...
        self.pos = Vector2(pos[0] * 32, pos[1] * 32)
        self.tile_id = tile_id
        self.flags = flags

        self.image = texture.subsurface(((self.tile_id % 16) * 32 + (self.tile_id % 16)*2, floor(self.tile_id / 16) * 32 + floor(self.tile_id / 16)*2, 32, 32))
